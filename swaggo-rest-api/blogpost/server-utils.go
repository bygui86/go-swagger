...
import (
	...
	// docs files are generated by Swag CLI, we have to import it to be served by http-swagger
	_ "github.com/bygui86/go-swagger/swaggo-rest-api/docs"
...
func (s *Server) setupHandlers() {
	...
	// swagger
	s.router.PathPrefix("/swagger-ui").Handler(httpSwagger.WrapHandler)
}
